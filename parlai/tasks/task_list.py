...
task_list = [
{
        "id": "facebook_msc_salmon",
        "display_name": "FacebookMSCSalmon",
        "task": "facebook_msc_salmon",
        "tags": ["ChitChat"],
        "description": (
            "This dataset contains current conversation and "
            "several history conversations before the current one between two users"
        )},
{
        "id": "facebook_msc_summary",
        "display_name": "FacebookMSCSummary",
        "task": "facebook_msc_summary",
        "tags": ["ChitChat"],
        "description": (
            "This dataset contains conversation and conversation summary of that conversation"
        )},
{
        "id": "facebook_msc",
        "display_name": "FacebookMSC",
        "task": "facebook_msc",
        "tags": ["ChitChat"],
        "description": (
            "This dataset contains current conversation and "
...
{
        "id": "facebook_msc_debug",
        "display_name": "FacebookMSC_debug",
        "task": "facebook_msc_debug",
        "tags": ["ChitChat"],
        "description": (
            "This dataset contains current conversation and "
            "several history conversations before the current one between two users. Debug mode. without multiteacher."
        )},
{
        "id": "twitter_conv",
        "display_name": "TwitterConv",
        "task": "twitter_conv",
        "tags": ["ChitChat"],
        "description": (
            "This dataset contains current conversation and "
